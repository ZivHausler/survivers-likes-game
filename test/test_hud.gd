...
func test_boss_spawned_shows_bar_with_name_and_max() -> void:
	...
	var bar := hud.get_node("BossBar") as Control
	var name_label := hud.get_node("BossBar/BossContent/BossNameLabel") as Label
	var hp_bar := hud.get_node("BossBar/BossContent/BossHPBar") as ProgressBar
...
func test_boss_hp_changed_updates_value_and_text() -> void:
	...
	var hp_bar := hud.get_node("BossBar/BossContent/BossHPBar") as ProgressBar
	var hp_text := hud.get_node("BossBar/BossContent/BossHPBar/BossHPText") as Label
